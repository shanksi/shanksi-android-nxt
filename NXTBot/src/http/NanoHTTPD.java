...
public class NanoHTTPD
{
							   ...
							   boolean allowDirectoryListing )
	{
		...
		NxtBrick nxt = LocalHttpService.getNxt();
		
		
		if(uri.equals("left")) {
			Log.e("NXTBotGuard", "left");
			res = new Response( HTTP_OK, MIME_PLAINTEXT, "ok");
			try {
				if(nxt != null) {
					nxt.setOutputState((byte)0x01, (byte)0x68, true, true, (byte)0x20);
				}
		...
		else if(uri.equals("right")) {
			Log.e("NXTBotGuard", "right");
			res = new Response( HTTP_OK, MIME_PLAINTEXT, "ok");
			try {
				if(nxt != null) {
					nxt.setOutputState((byte)0x02, (byte)0x68, true, true, (byte)0x20);
				}
		...
		else if(uri.equals("up")) {
			Log.e("NXTBotGuard", "up");
			res = new Response( HTTP_OK, MIME_PLAINTEXT, "ok");
			try {
				if(nxt != null) {
					nxt.setOutputState((byte)0xff, (byte)-0x68, true, true, (byte)0x20);
				}
			...
			Log.e("NXTBotGuard", "stop");
			res = new Response( HTTP_OK, MIME_PLAINTEXT, "ok");
			try {
				if(nxt != null) {
					nxt.setOutputState((byte)0xff, (byte)0x68, true, true, (byte)0x00);
				}
